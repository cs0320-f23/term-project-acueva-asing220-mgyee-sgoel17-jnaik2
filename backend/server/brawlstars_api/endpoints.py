...
def get_icons() -> BSAPIResponse:
    """
    """
    api_url = "https://api.brawlapi.com/v1/icons"
    ...
    try:
        ...
        return BSAPIResponse(BSAPIResponseType.HTTP_ERROR, f'Error occurred: {http_err}', data)
    except Exception as err:
        return BSAPIResponse(BSAPIResponseType.OTHER_ERROR, f'Error occurred: {err}', data)
